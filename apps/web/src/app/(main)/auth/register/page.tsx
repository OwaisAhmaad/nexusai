...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-[#F5F4F0] px-4 py-8">
      <div className="flex w-full rounded-2xl shadow-2xl overflow-hidden" style={{ maxWidth: '820px' }}>
        ...
        {/* RIGHT PANEL */}
        <div className="flex-1 bg-white rounded-r-2xl sm:rounded-l-none rounded-2xl p-7 overflow-y-auto">
          {/* Tabs */}
          <div className="flex gap-6 border-b border-[#E5E5E5] mb-5">
            <Link href="/auth/login" className="pb-3 text-[14px] font-semibold text-[#9CA3AF] hover:text-[#6B7280] transition -mb-px border-b-2 border-transparent">
              Sign In
            </Link>
          ...
          <h2 className="text-[22px] font-black text-[#1A1A1A] mb-0.5">Create your account</h2>
          <p className="text-[13px] text-[#6B7280] mb-4">Get started with NexusAI — it&apos;s free.</p>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-3">
            ...
            <div>
              ...
              <input type="password" placeholder="Create a strong password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={8} autoComplete="new-password"
                className="w-full bg-[#F5F4F0] border-0 rounded-xl px-4 py-2.5 text-[14px] text-[#1A1A1A] placeholder-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#E8521A]/30 transition"/>
            ...
            <div>
              ...
              <input type="password" placeholder="Confirm your password" value={confirm} onChange={(e) => setConfirm(e.target.value)} required autoComplete="new-password"
                className="w-full bg-[#F5F4F0] border-0 rounded-xl px-4 py-2.5 text-[14px] text-[#1A1A1A] placeholder-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#E8521A]/30 transition"/>
            </div>
          ...
          <p className="text-[13px] text-[#6B7280] text-center mt-4">
            ...
            <Link href="/auth/login" className="text-[#E8521A] hover:underline font-semibold">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
